...
import com.blazeapps.weatherapp.internal.NoConnectivityException
...
class WeatherNetworkDataSourceImpl(
    ...
    override suspend fun fetchCurrentWeather(location: String, languageCode: String) {
        try {
            ...
            Log.e("Request error", "Request error", e)
        }
    }
    ...
    override suspend fun fetchFutureWeather(location: String, languageCode: String) {
        try {
            val fetchedFutureWeather = apixuWeatherApiService
                .getFutureWeather(location, FORECAST_DAYS_COUNT, languageCode).await()
